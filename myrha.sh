...
printf '# ' >> $LOGPATH/mos_cluster; ls ./$MCCNAME/objects/namespaced/$MOSNAMESPACE/lcm.mirantis.com/lcmclusters/$MOSNAME.yaml >> $LOGPATH/mos_cluster
...
SUBL_MAC="/Applications/Sublime\ Text.app/Contents/SharedSupport/bin/subl"
SUBL_LINUX="/usr/bin/subl"
$SUBL_MAC --new-window --command $LOGPATH/*.yaml 2> /dev/null
$SUBL_LINUX --new-window --command $LOGPATH/*.yaml 2> /dev/null
